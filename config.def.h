...
static const char *dmenucmd[]    = { "dmenu_run", "-l 30", "Run: ", NULL };
...
//	{ Mod1Mask,             -1,        XK_Return, spawn,          {.v = tabtermcmd } },
	{ MODKEY|ShiftMask,     -1,        XK_Return, spawn,          CMD("st") },
	{ MODKEY,     		-1,        XK_v,      spawn,          CMD("neovide") },
...
//	{ MODKEY,               -1,        XK_d,      incnmaster,     {.i = -1 } },
	...
	//PROGRAM KEYBINDINGS
	{ MODKEY,               -1,        XK_s,      spawn,          CMD("tabbed -r 2 surf -pe x '.surf/html/homepage.html'") },
	{ MODKEY,               -1,        XK_b,      spawn,          CMD("brave") },
	{ MODKEY,               -1,        XK_p,      spawn,          CMD("okular") },
